...
const Listar = () => {
    ...
    return (
        <div >
            <h1 className='font-black text-4xl text-gray-500'>Técnicos</h1>
            <hr className='my-4' />
            <div style={{ width: 'auto', margin: 'auto', display: 'flex', padding: '0.5em' }}>

                <p className='mb-8'>Este módulo estan registrados los técnicos</p>
                ...
                className='bg-gray-600 w-auto p-1  text-slate-300 uppercase font-bold rounded-lg 
                    ...
                    onClick={() => navigate(`/dashboard/agregarTecnico`)}
                value='Registrar'
            />
